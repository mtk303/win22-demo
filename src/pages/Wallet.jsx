...
const WalletPage = () => {
  ...
  return (
    <div className="py-5 px-3 px-lg-5 ">
        ...
        <div className=' d-flex flex-wrap flex-lg-nowrap justify-content-center  gap-md-5 '>
            ...
            <div style={{width:'100%'}} className="mb-4 border p-3 rounded-3">
                ...
                <div style={{textAlign:'end'}}>
                    <Button className='walletBtn'>ငွေသွင်းမည်</Button>
                </div>
            ...
            <div style={{width:'100%'}} className="mb-4 border p-3 rounded-3">
               ...
               <div className=" d-flex flex-wrap flex-sm-nowrap  align-items-center justify-content-between">
                ...
                <div style={{textAlign:'end'}}>
                    <Button  className='walletBtn'>ငွေထုတ်မည်</Button>
                </div>
            ...
            <div style={{width:'100%'}} className="mb-4 border p-3 rounded-3">
                ...
                <div style={{textAlign:'end'}}>
                    <Button className='walletBtn'>တင်သွင်းမည်</Button>
                </div>
